...
layui.config({base : "assets/"}).extend({"liuyaregion_config":"admin/liuyaregion/liuyaregion-config","magicalcoderlist" : "magicalcoder/v001/rmp/magicalcoderlist"})
layui.use(["magicalcoderlist","liuyaregion_config"],function(){
    var config = $.extend(layui.liuyaregion_config,{
        layTable : {
            //表格内容
            elem : '#newsList',
            id : "newsListTable"
