...
layui.config({base : "assets/"}).extend({"liuyatype_config":"admin/liuyatype/liuyatype-config","magicalcoderlist" : "magicalcoder/v001/rmp/magicalcoderlist"})
layui.use(["magicalcoderlist","liuyatype_config"],function(){
    var config = $.extend(layui.liuyatype_config,{
        childrenPage:[
            {
                tabTitle:"评论表",
