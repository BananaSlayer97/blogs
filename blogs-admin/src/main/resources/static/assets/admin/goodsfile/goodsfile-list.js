    ...
    var cols = [[
        {type: "checkbox", fixed:"left", width:50},
            ...
            {field: 'fileSrc', title: '文件地址', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ magicalcoderlist.escapeHTML(d.fileSrc) +'" class="magicalcoder-table-text layui-input security_list_table_form_fileSrc" name="fileSrc" data-identify="'+d.fileId+'" lay-verify="magicalCoderVerify" magicalcoder-verify=""  placeholder="文件地址"/>'
                }
                , sort:true
            },

            {field: 'goodsId', title: '所属商品', minWidth:200,templet:function (d) {
                    return '<input type="text" value="'+ magicalcoderlist.escapeHTML(d.goodsId) +'" class="magicalcoder-table-text layui-input security_list_table_form_goodsId" name="goodsId" data-identify="'+d.fileId+'" lay-verify="magicalCoderVerify" magicalcoder-verify=""  placeholder="所属商品"/>'
                }
                , sort:true
            },
