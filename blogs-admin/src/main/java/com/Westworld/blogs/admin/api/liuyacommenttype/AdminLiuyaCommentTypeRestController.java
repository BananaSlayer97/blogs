package com.Westworld.blogs.admin.api.liuyacommenttype;
...
import com.Westworld.blogs.model.LiuyaCommentType;
import com.Westworld.blogs.service.liuyacommenttype.service.LiuyaCommentTypeService;
...
@RequestMapping("/admin/liuya_comment_type_rest/")
@RestController
public class AdminLiuyaCommentTypeRestController extends CommonRestController<LiuyaCommentType,Integer> implements InitializingBean
{

    @Resource
    private LiuyaCommentTypeService liuyaCommentTypeService;
        ...
        @RequestParam int page,@RequestParam int limit,@RequestParam(required = false) String safeOrderBy)
    {
        ...
        Integer count = liuyaCommentTypeService.getModelListCount(query);
        ...
        return new ResponseMsg(count,liuyaCommentTypeService.getModelList(query));
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        super.commonService = liuyaCommentTypeService;
