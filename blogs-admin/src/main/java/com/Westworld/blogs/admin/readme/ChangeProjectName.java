package com.Westworld.blogs.admin.readme;


import com.Westworld.blogs.core.common.file.FileHelper;
...
public class ChangeProjectName {
    private static String[] source = {"com.Westworld.youyamvc","youyamvc"};//com.Westworld.youyamvc youyamvc
