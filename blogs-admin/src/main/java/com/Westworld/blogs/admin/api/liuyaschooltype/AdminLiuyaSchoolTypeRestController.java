package com.Westworld.blogs.admin.api.liuyaschooltype;
...
@RequestMapping("/admin/liuya_school_type_rest/")
@RestController
public class AdminLiuyaSchoolTypeRestController extends CommonRestController<LiuyaSchoolType,Integer> implements InitializingBean
{

    @Resource
    private LiuyaSchoolTypeService liuyaSchoolTypeService;
        ...
        @RequestParam int page,@RequestParam int limit,@RequestParam(required = false) String safeOrderBy)
    {
        ...
        Integer count = liuyaSchoolTypeService.getModelListCount(query);
        ...
        return new ResponseMsg(count,liuyaSchoolTypeService.getModelList(query));
    }

    @Override
    public void afterPropertiesSet() throws Exception {
        super.commonService = liuyaSchoolTypeService;
