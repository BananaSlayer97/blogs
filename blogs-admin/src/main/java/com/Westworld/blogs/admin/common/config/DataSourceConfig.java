package com.Westworld.blogs.admin.common.config;
...
@MapperScan(basePackages =
        {"com.Westworld.blogs.admin.**.mapper"
        ,"com.Westworld.blogs.admin.rmp.**.mapper" // 如果您觉得日志有warn mapper已经存在 比较碍眼 可以注释本行
        ,"com.Westworld.blogs.service.**.mapper"
        }
...
public class DataSourceConfig {
    ...
    private static final String TYPE_ALIASES_PACKAGE =
            "com.Westworld.blogs.admin.model," +
            "com.Westworld.blogs.admin.rmp.model," +
            "com.Westworld.blogs.model";//逗号分隔多个
